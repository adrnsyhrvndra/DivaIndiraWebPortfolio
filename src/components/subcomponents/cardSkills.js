    ...
    <>
      <div className="col-span-12 gap-11 mb-11 md:gap-0 md:mb-0 md:col-span-6">
        <div
          ...
          className="bg-[#FDFDFD] cursor-pointer flex flex-1 shadow-md rounded-2xl text-center text-[#35352F] hover:bg-cream-web md:shadow-lg py-12 px-14 md:py-10 md:px-9 xl:py-16 xl:px-14 xl:rounded-2xl"
        >
          <div className="mx-auto text-center">
            <img className="mx-auto w-36 md:w-24 xl:w-36 2xl:w-44" src={
              trueIconHover ?  tangkapProps.iconBrown : tangkapProps.icon
            } alt="" />
            <h2 className="text-wrap break-words font-black text-[2.8rem] mt-6 text-center  md:text-[1.8rem] lg:text-[2.3rem] xl:mt-6 2xl:text-[2.8rem]">
