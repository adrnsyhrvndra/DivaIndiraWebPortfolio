    ...
    <>
      <div className="col-span-12 gap-11 mb-11 md:gap-0 md:mb-0 md:col-span-6">
        <div
          ...
          className="bg-[#FDFDFD] flex flex-1 shadow-md rounded-2xl text-center md:shadow-lg py-12 px-14 md:py-10 md:px-9 xl:py-16 xl:px-14 xl:rounded-2xl hover:bg-cream-web"
        >
