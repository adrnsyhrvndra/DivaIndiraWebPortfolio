      ...
      return (
            <>
                  <div className="flex flex-row mx-auto justify-center items-center gap-3 mt-1 min-[550px]:mt-2 min-[550px]:gap-4 lg:mt-3 lg:gap-5 xl:gap-6 xl:mt-6 xl:mx-auto w-fit">
                        ...
                        <h2 className="font-black text-[#35352F] text-center text-[1.2rem] min-[550px]:text-3xl md:text-[2.4rem] lg:text-[2.7rem] xl:text-6xl 2xl:text-7xl">
                              Skill dan Kemampuan
                        </h2>
                        <svg
                              xmlns="http://www.w3.org/2000/svg"
