...
import divaSectionMobile from "../img/divaphone-hero.png";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="font-black text-[#333232] text-[2.3rem] text-center mt-4 leading-[2.4rem] md:mt-6 md:text-[4.2rem] md:leading-[4.3rem] lg:text-start lg:text-[2.5rem] lg:leading-[2.7rem] lg:mt-4 xl:text-[3.3rem] xl:leading-[3.9rem] xl:mt-4 min-[1440px]:text-[3.8rem] 2xl:text-[4.1rem] 2xl:leading-[4.3rem] 2xl:mt-6 min-[1650px]:text-[4.5rem] min-[1750px]:text-[4.7rem] min-[1750px]:leading-[4.9rem] min-[1900px]:leading-[5.2rem] min-[1900px]:text-[5.1rem]">
          Hello I’m <br />
        ...
        <div className="flex flex-row justify-center items-center mt-6 gap-5 md:mt-8 lg:justify-start xl:gap-6 xl:mt-6 2xl:mt-10">
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-semibold md:text-[1.25rem] lg:text-[1rem] min-[1440px]:text-[1.4rem] 2xl:text-[1.6rem] min-[1700px]:text-[1.8rem]"
            >
              View's linkedin
            </a>
            <svg
      ...
      <div className="col-span-12 order-2 md:order-1 md:mt-10 lg:mt-0 lg:order-2 lg:col-span-7">
        <img aria-label="image-for-laptop" className="hidden md:block md:w-[80%] md:mx-auto lg:w-full" src={divaSection} alt="" />
        <img aria-label="image-for-mobile" className="w-[90%] mx-auto md:hidden" src={divaSectionMobile} alt="" />
      </div>
    </div>
  );
};
